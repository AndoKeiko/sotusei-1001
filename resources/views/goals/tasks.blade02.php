      ...
      <div class="p-6 bg-white border-b border-gray-200">
        ...
        @endif
          <a href="{{ route('goals.schedule', $goal->id) }}"
            class="display-inline px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"> スケジュールを表示</a>
        <div class="mt-8">
